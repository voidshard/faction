...
func Actions() map[string]*config.Action {
	...
	return map[string]*config.Action{
		...
		Bribe: {
			...
			SecrecyWeight:  1.5,
			Goals:          []structs.Goal{structs.GoalDiplomacy},
		...
		Propoganda: {
			...
			SecrecyWeight:  1.1,
			Goals:          []structs.Goal{structs.GoalPower},
		...
		Consolidate: {
			...
			SecrecyWeight: 1,
			Goals:         []structs.Goal{structs.GoalStability},
		},
		Research: {
			MinPeople:   1,
			MaxPeople:   100,
			Target:      structs.MetaKeyResearch,
			Probability: 0.3,
			JobPriority: 50,
		...
		ConcealSecrets: {
			...
			SecrecyWeight: 1.5,
			Goals:         []structs.Goal{structs.GoalStability, structs.GoalEspionage},
		},
		GatherSecrets: {
			MinPeople:    2,
			MaxPeople:    14,
		...
		SpreadRumors: {
			...
			SecrecyWeight:  1.3,
			Goals:          []structs.Goal{structs.GoalPower, structs.GoalEspionage},
			TargetMinTrust: structs.MinEthos / 2,
		...
		Raid: {
			...
			RefundOnFailure: 0.2,
			SecrecyWeight:   1.1,
			Goals:           []structs.Goal{structs.GoalMilitary, structs.GoalWealth},
			TargetMinTrust:  (structs.MinEthos * 3) / 4,
			TargetMaxTrust:  structs.MinEthos / 2,
		},
		Enslave: {
			...
			RefundOnFailure: 0.2,
			SecrecyWeight:   1.05,
			Goals:           []structs.Goal{structs.GoalGrowth, structs.GoalPower},
			TargetMinTrust:  (structs.MinEthos * 3) / 4,
			TargetMaxTrust:  structs.MinEthos / 2,
		},
		Steal: {
